...
class AISDataset(Dataset):
        ...
        Args
            l_data: list of dictionaries, each element is an AIS trajectory. 
                ...
                l_data[idx]["traj"]: a matrix whose columns are 
                    ...
                    [LAT, LON, SOG, COG,deltaTime, TIMESTAMP]
                #lat, lon, sog, and cod have been standardized, i.e. range = [0,1).
                lat, lon, sog, cod and deltaTime have been standardized, i.e. range = [0,1).
    ...
    def __getitem__(self, idx):
        ...
        Returns:
            ...
            seq: Tensor of (max_seqlen, [lat,lon,sog,cog,deltaTime]).
        ...
        m_v = V["traj"][:,:5] # lat, lon, sog, cog,deltaTime
#         m_v[m_v==1] = 0.9999

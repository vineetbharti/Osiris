...
#     device = torch.device("cpu")
    ...
    #trainset_name = f"{dataset_name}_train_with_time.pkl"
    #validset_name = f"{dataset_name}_valid_with_time.pkl"
    #testset_name = f"{dataset_name}_test_with_time.pkl"
    
    trainset_name = f"train_jun2dec2006.pkl"
    validset_name = f"train_jun2dec2006.pkl"
    testset_name = f"train_jun2dec2006.pkl"
    ...
    full_size = lat_size + lon_size + sog_size + cog_size + deltaTime_size
    #n_embd = n_lat_embd + n_lon_embd + n_sog_embd + n_cog_embd
    n_embd = n_lat_embd + n_lon_embd + n_sog_embd + n_cog_embd + n_deltaTime_embd
